...
var json_fb='https://taghash.co/mloyalApps/facebookwaghbakri.php';
var RSS_twitter='https://taghash.co/mloyalApps/twitter.php?uname=waghbakrihome';
var RSS_pinterest='http://103.25.128.61/projects/taghash/mloyalApps/pinteresttantra.php?brand=waghbakri';
var RSS_instagram='https://www.instagram.com/waghbakri/?__a=1';
var RSS_youtube='http://xceedfbapps.com/mloyalfeeds/youtube.php?brandname=waghbakri';
var RSS_tumblr='http://xceedfbapps.com/mloyalfeeds/tumblr.php?brandurl=http://waghbakri.tumblr.com';

var brandname='waghbakri';
var aboutus_det='waghbakri';
var brand_url='https://www.wbtealounge.com/';
var cart = { cartdata: []};
...
var SERVER = "https://waghbakritealounge.mloyalretail.com/m/";
var SERVER1 = "https://waghbakritealounge.mloyalretail.com/";
...
$(document).ready(function(event){
			   ...
			   if($.mobile.activePage.is('#homepage')){
                 ...
                 //getContacts();
                  if(localStorage.getItem("usernamewaghbakri")!=null && localStorage.getItem("usernamewaghbakri")!='' && localStorage.getItem("passwordwaghbakri")!=null && localStorage.getItem("passwordwaghbakri")!='')
                    {
                            $('#username').val(localStorage.getItem("usernamewaghbakri"));
                            $('#password_myacc').val(localStorage.getItem("passwordwaghbakri"));
							user.mobile = localStorage.getItem('usernamewaghbakri');
							var pwd = localStorage.getItem('passwordwaghbakri');
                        ...
                        if(user.mobile=='undefined' || user.mobile=='null' || user.mobile==null)
                           ...
                           // alert(user.firstname);
                            ...
                            document.getElementById("profilepts1").innerHTML=user.total+' points';
                             ...
                             $("#wait").css("display","none");
                             authenticate();
                          if(imageExists('https://taghash.co/mloyalfileupload/uploads/waghbakri_'+localStorage.getItem("usernamewaghbakri")+'.jpg'))
                          {
                              document.getElementById("cardImagemenu").src='https://taghash.co/mloyalfileupload/uploads/waghbakri_'+localStorage.getItem("usernamewaghbakri")+'.jpg';
                          }                     
                     }
				   else if(localStorage.getItem("usernamewaghbakri")!=null && localStorage.getItem("usernamewaghbakri")!='' && (localStorage.getItem("passwordwaghbakri")==null || localStorage.getItem("passwordwaghbakri")=='')) 
	                 {
			...
			success: function(data, textStatus, xhr) {
			 ...
			 if(data.toLowerCase()=='success'){
				 ...
				 $('#login-msg').html('The  passcode has been sent to your mobile.Please check your SMS.');
			      ...
			      $('#username').val(mob);
				  localStorage.setItem('usernamewaghbakri',mob);
...
function authenticate(){
 ...
 if(uname=='' || pwd==''){
  ...
  $.ajax({
   ...
   localStorage.setItem('usernamewaghbakri',uname);
   localStorage.setItem('passwordwaghbakri',pwd);
 ...
 if(user.mobile=='undefined' || user.mobile=='null' || user.mobile==null)
    ...
    {
	    if(localStorage.getItem("profiledone_waghbakri")){
    ...
    error: function(xhr, textStatus, errorThrown) {
	user.mobile = localStorage.getItem('usernamewaghbakri');
	pwd = localStorage.getItem('passwordwaghbakri');
	uname = user.mobile;
    user.balance = localStorage.getItem('balance');
    user.firstname = localStorage.getItem('firstname');
    user.lastname = localStorage.getItem('lastname');
...
$(document).on('pageinit', '#profilepage', function (event, ui) {
	...
	$.ajax({
			...
			success: function(data, textStatus, xhr) {
				...
				localStorage.setItem("profiledone_waghbakri","Yes");
...
function showRewards(){
	...
	openInWebView('https://waghbakritealounge.mloyalretail.com/microsite/');
	//RewardsNA();
	/*
	if(user.mobile==null || user.mobile=='')
	{
...
if(id=='rewardstore' || id=='reward-cat' || id=='reward-brand')
	{
	tabserver = "https://waghbakritealounge.mloyalretail.com/Rewards/";
	}
else
	{
	
	tabserver = "https://waghbakritealounge.mloyalretail.com/m/";
	}
	$.getJSON(
		tabserver+url, {
		//page: url,
...
function renderTemplate(pageID, json) {
	...
	case 'inbox':
        ...
        str += '<span class="msghdr">DM-WBLTEA</span><span class="msgTime">'+json[i].msgtime+'</span>';
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json);
          ...
          localStorage.setItem('facebook_waghbakri',JSON.stringify(json.item));
		 ...
		 try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('facebook_waghbakri')));
		 }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.feed.entry);
          ...
          localStorage.setItem('youtube_waghbakri',JSON.stringify(json.feed.entry));
		   ...
		   try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('youtube_waghbakri')));
		   }
		   catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
...
else if(url==RSS_twitter)
{
  ...
  $.ajax({
            ...
            localStorage.setItem('twitter_waghbakri', JSON.stringify(data));
                },
                error: function (xhr, textStatus, errorThrown) {
				...
				{
					renderTemplate(id, JSON.parse(localStorage.getItem('twitter_waghbakri')));
					//alert('here in catch');
				}
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.body);
          ...
          localStorage.setItem('pinterest_waghbakri',JSON.stringify(json.body));
		   ...
		   try{
			    renderTemplate(id,JSON.parse(localStorage.getItem('pinterest_waghbakri')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_tumblr)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('tumblr_waghbakri',JSON.stringify(json.channel.item));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('tumblr_waghbakri')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_instagram)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('instagram_waghbakri',JSON.stringify(json.user));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('instagram_waghbakri')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
function receivedEvent(id) {
 ...
 var push = PushNotification.init({ "android": {"senderID": "131539146950"}});
...
function addincart(i)
{
	...
	cart.cartdata.push({ 
   "index":i,
   "url" : "https://waghbakritealounge.mloyalretail.com/"+jsonary[i].brand_logo,
...
function checkout(){
  ...
  $.ajax({
    url: 'https://waghbakritealounge.mloyalretail.com/Rewards/complete.asp',
    type: 'GET',
    timeout: 50000,
...
function giftfriend(){
  ...
  var val=$('#giftpt').val();
  $.ajax({
    url: 'https://waghbakritealounge.mloyalretail.com/m/gift_points_api.asp',
    type: 'GET',
    timeout: 50000,
    dataType: 'text', //xml/html/script/json/jsonp
...
function shareApp()
{
	window.plugins.socialsharing.share('Hi, WBTL Loyalty.', null, 'https://taghash.co/shareimg/waghbakri.jpg', 'https://waghbakritealounge.mloyalretail.com/mapp');
}
		 ...
		 if (deviceType=='iPad' || deviceType=='iPhone') 
			 {
				...
				window.open('https://waghbakritealounge.mloyalretail.com/mapp');
			 } 
		 else if (deviceType=='Android') 
			 {
               window.open("market://details?id=com.mobiquest.waghbakri","_system");
...
{
	//var ref = window.open('https://www.facebook.com/waghbakri', '_blank');
	var ref = cordova.InAppBrowser.open('https://www.facebook.com/waghbakri', '_blank', 'location=yes');
}

function showTwitterNew_1()
{
	//var ref = window.open('https://twitter.com/waghbakri', '_blank');
	var ref = cordova.InAppBrowser.open('https://twitter.com/waghbakri', '_blank', 'location=yes');
}

function showInstagramNew_1()
{
	//var ref = window.open('https://www.instagram.com/waghbakri', '_blank');
	var ref = cordova.InAppBrowser.open('https://www.instagram.com/waghbakri', '_blank', 'location=yes');
}

function showYoutubeNew_1()
{
	//var ref = window.open('https://www.youtube.com/', '_blank');
	var ref = cordova.InAppBrowser.open('https://www.youtube.com/', '_blank', 'location=yes');
}

function showLinkedinNew_1()
{
	//var ref = window.open('https://in.linkedin.com/company/waghbakri', '_blank');
	var ref = cordova.InAppBrowser.open('https://in.linkedin.com/company/waghbakri', '_blank', 'location=yes');
}
...
function showShop()
{
    //openInWebView('https://www.wbtealounge.com/');
	//var ref = window.open('https://www.wbtealounge.com/', '_blank');
	var ref = cordova.InAppBrowser.open('https://www.wbtealounge.com/', '_blank', 'location=yes');
...
$("input[type=file]").change(function(){
  ...
  // alert($("input[type=file]")[0].files[0]);
	...
	aFormData.append("mobile", localStorage.getItem("usernamewaghbakri"));
    aFormData.append("brand", "waghbakri");
	...
	$.ajax(
    {
      ...
      success     : 
        function(data)
        {
         ...
         document.getElementById("cardImagemenu").src='https://taghash.co/mloyalfileupload/uploads/waghbakri_'+localStorage.getItem("usernamewaghbakri")+'.jpg';
      //   document.getElementById("cardImage").src='http://103.25.128.61:9296/mloyalfileupload/uploads/waghbakri_'+localStorage.getItem("usernamewaghbakri")+'.jpg';
        }
    });
...
function logoutApp()
{
	localStorage.setItem("usernamewaghbakri",'');
	localStorage.setItem("passwordwaghbakri",'');
	localStorage.setItem("profiledone_waghbakri",'');
...
function uploadPhoto(imageURI) {
				...
				var fName='waghbakri_'+user.mobile;
